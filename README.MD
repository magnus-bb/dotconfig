...
Allows you to save themes for users instead of all users.

###

## Theming
All themes, cursors, and icons can be found in `~/.themes/` and `~/.icons/`. Remember to install gnome-tweaks and User Themes to apply them.
